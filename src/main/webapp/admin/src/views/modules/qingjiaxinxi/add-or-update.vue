    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="请假事由" prop="qingjiashiyou">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qingjiashiyou" label="请假事由" prop="qingjiashiyou">
                    <span v-html="ruleForm.qingjiashiyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qingjiashiyou = this.ruleForm.qingjiashiyou.replace(reg,'../../../ssmn412p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
