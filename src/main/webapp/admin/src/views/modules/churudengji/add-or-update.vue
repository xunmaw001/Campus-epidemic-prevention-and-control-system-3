<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="登记姓名" prop="dengjixingming">
          <el-input v-model="ruleForm.dengjixingming" 
              placeholder="登记姓名" clearable  :readonly="ro.dengjixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="登记姓名" prop="dengjixingming">
              <el-input v-model="ruleForm.dengjixingming" 
                placeholder="登记姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="角色类型" prop="jiaoseleixing">
          <el-select :disabled="ro.jiaoseleixing" v-model="ruleForm.jiaoseleixing" placeholder="请选择角色类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="角色类型" prop="jiaoseleixing">
	      <el-input v-model="ruleForm.jiaoseleixing"
                placeholder="角色类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="入校事由" prop="ruxiaoshiyou">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.ruxiaoshiyou" label="入校事由" prop="ruxiaoshiyou">
                    <span v-html="ruleForm.ruxiaoshiyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='dengjixingming'){
            this.ruleForm.dengjixingming = obj[o];
	    this.ro.dengjixingming = true;
            continue;
          }
          if(o=='xingbie'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jiaoseleixing'){
            this.ruleForm.jiaoseleixing = obj[o];
	    this.ro.jiaoseleixing = true;
            continue;
          }
          if(o=='shenfenzheng'){
	...
	this.ruleForm.ruxiaoshiyou = this.ruleForm.ruxiaoshiyou.replace(reg,'../../../ssmn412p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
