<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="返回时间" prop="fanhuishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fanhuishijian" label="返回时间" prop="fanhuishijian">
              <el-input v-model="ruleForm.fanhuishijian" 
                placeholder="返回时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="返程地区" prop="fanchengdiqu">
          <el-input v-model="ruleForm.fanchengdiqu" 
              placeholder="返程地区" clearable  :readonly="ro.fanchengdiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="返程地区" prop="fanchengdiqu">
              <el-input v-model="ruleForm.fanchengdiqu" 
                placeholder="返程地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="返回地点" prop="fanhuididian">
          <el-input v-model="ruleForm.fanhuididian" 
              placeholder="返回地点" clearable  :readonly="ro.fanhuididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="返回地点" prop="fanhuididian">
              <el-input v-model="ruleForm.fanhuididian" 
                placeholder="返回地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="行动轨迹" prop="xingdongguiji">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xingdongguiji" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xingdongguiji" label="行动轨迹" prop="xingdongguiji">
                    <span v-html="ruleForm.xingdongguiji"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fanhuishijian = true;
          ...
          if(o=='fanchengdiqu'){
            this.ruleForm.fanchengdiqu = obj[o];
	    this.ro.fanchengdiqu = true;
            continue;
          }
          if(o=='fanhuididian'){
            this.ruleForm.fanhuididian = obj[o];
	    this.ro.fanhuididian = true;
            continue;
          }
          if(o=='xingdongguiji'){
            this.ruleForm.xingdongguiji = obj[o];
	    this.ro.xingdongguiji = true;
            continue;
          }
          if(o=='jiankangma'){
	...
	this.ruleForm.xingdongguiji = this.ruleForm.xingdongguiji.replace(reg,'../../../ssmn412p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fanchengshangbao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fanchengshangbaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
