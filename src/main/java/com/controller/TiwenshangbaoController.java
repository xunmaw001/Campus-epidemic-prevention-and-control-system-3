...
public class TiwenshangbaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TiwenshangbaoEntity tiwenshangbao, 
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			tiwenshangbao.setZhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TiwenshangbaoEntity tiwenshangbao, 
		HttpServletRequest request){
        EntityWrapper<TiwenshangbaoEntity> ew = new EntityWrapper<TiwenshangbaoEntity>();
		PageUtils page = tiwenshangbaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tiwenshangbao), params), params));
        return R.ok().put("data", page);
